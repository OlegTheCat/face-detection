...
int main(int argc, char *argv[]){
    ...
    e_reset_group(&dev);
    printf("Successfully opened all cores.\n");
    ...
    printf("Initialized input vectors.\n");
    ...
    e_load_group("e-face-detection.srec", &dev, 0, 0, platform.rows, platform.cols, E_TRUE);

    printf("Loaded program to cores.\n");
